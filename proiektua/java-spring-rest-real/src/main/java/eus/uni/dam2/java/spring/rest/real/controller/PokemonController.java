 ...
 */
package eus.uni.dam2.java.spring.rest.real.controller;
...
public class PokemonController {
    ...
    public PersonController(PersonRepository personRepository) {
        this.pokemonRepository = personRepository;
    }
    ...
    public Long deletePokemones(@PathVariable int ids) {
        List<String> listIds = asList(ids.split(","));
    ...
    @PutMapping("pokemon")
    public Person putPokemon(@RequestBody Pokemon pokemon) {
